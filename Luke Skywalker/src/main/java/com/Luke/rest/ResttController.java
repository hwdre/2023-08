...
public class ResttController {
	...
	/*
	 * json.put("totalCount", 128); json.put("pageNo", 1); json.put("list", arr);
	 * boardList2 = {totalCount: 128, pageNo: 1, list: [ {bno:1, btitle:...},
	 * {bno:1, btitle:...}, {bno:1, btitle:...}, {bno:1, btitle:...}, {bno:1,
	 * btitle:...}, {bno:1, btitle:...}, {bno:1, btitle:...}, {bno:1, btitle:...},
	 * {bno:1, btitle:...}, {bno:1, btitle:...} ]} 커다란 오브젝트 안에 값이 3개 있는데 지금은 그 중에
	 * 리스트 뽑는 중입니다. 객체: {키: 값, 이름: 값,....} 계속 반복되는데 이 값 부분에 object가 들어가요 커다란 오브젝트 속에
	 * 오브젝트가 있어요.
	 */
...
//					&& !(map.get("cno").equals("")) && util.isNum(map.get("bno")) && 
